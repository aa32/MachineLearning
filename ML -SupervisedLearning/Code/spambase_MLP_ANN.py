...
print ("Accuracy on training set with MLP spambase is %5f",metrics.balanced_accuracy_score(y_train,y_pred_train))
print ("Accuracy with test set with MLP spambase is %5f",metrics.balanced_accuracy_score(y_test,y_pred))

print(confusion_matrix(y_test, y_pred))  
print(classification_report(y_test, y_pred))  

plot_learning_curve(model,'Spambase Learning Curve for ANN',X_train,y_train,ylim =(0.7,1.1,.05),cv =10,n_jobs =-1)
